...
/**
 * TopBar — responsive header for DFO Dashboard.
 ...
 */
export default function TopBar({ title, subtitle, month, onMonth, showDownload = true, showMonthPicker = true, onOpenSidebar }) {
  const navigate = useNavigate();

  function handleSignOut() {
    sessionStorage.removeItem('msme_dfo_auth');
  ...
  return (
    <header className="bg-[#0d1f4c] text-white flex-shrink-0 border-b border-white/10">
      ...
      <div className="hidden lg:flex items-center h-[76px] px-4 xl:px-1 relative">
        ...
        {/* Right: controls — ml-auto pushes to far right */}
      ...
      <div className="lg:hidden">
        ...
        <div className="flex items-center px-3 py-2 gap-2">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0 ml-auto">
            {showMonthPicker && <MonthYearPicker value={month} onChange={onMonth} />}
            {showDownload && (
